...
|---|---|---|
| **LMS API** | full learning management system backend — courses, enrolments, progress tracking | Node, Express, MongoDB |
| **PMS API** | project management backend — workspaces, tasks, team roles | Node, Express, MongoDB |
...
if you're building something interesting in the backend space — APIs, platforms, tools — or if you just want to pair-program or do a code review swap, hit me up.

no gatekeeping here. let's build and grow together.

[![Twitter DM](https://img.shields.io/badge/reach%20me%20on%20twitter-%231DA1F2.svg?style=for-the-badge&logo=Twitter&logoColor=white)](https://twitter.com/ben_alanche)
